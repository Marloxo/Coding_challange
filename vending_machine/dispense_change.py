...
class DispenseChange(State):
    ...
    def display_stock(self) -> None:
        logging.critical("Can't display stock in dispense change state")

    def select_item(self, product_code) -> None:
        logging.critical("Can't select item in dispense change state")

    def collect_cash(self, amount) -> None:
        logging.critical("Can't collect cash in dispense change state")

    def dispense_item(self) -> None:
        logging.critical("Can't dispense item in dispense change state")
    ...
    def dispense_change(self) -> None:
        ...
        if remaining_amount:
            ...
            logging.info('No remaining amount')
    ...
    def cancel_transaction(self) -> None:
        logging.critical("Can't cancel transaction in dispense change state")
