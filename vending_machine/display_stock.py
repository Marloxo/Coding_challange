...
class DisplayStock(State):
    ...
    def collect_cash(self, amount) -> None:
        logging.critical(f"Can't collect cash in a display stock state")


    def dispense_item(self) -> None:
        logging.critical(f"Can't dispense item in a display stock state")


    def dispense_change(self) -> None:
        logging.critical(f"Can't cancel transaction in a display stock state")
